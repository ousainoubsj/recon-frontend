...
export default function AuthForm() {
  ...
  return (
    <div className="relative w-full max-w-md rounded-2xl bg-[#FEFEFE] p-8 pt-12 shadow-2xl shadow-slate-900/10 ring-1 ring-slate-900/5">
      <div className="absolute left-1/2 top-0 flex h-22 w-22 -translate-x-1/2 -translate-y-1/2 items-center justify-center overflow-hidden rounded-full bg-[#FEFEFE] shadow-lg ring-1 ring-slate-100">
      ...
      <div className="flex flex-col items-center pt-4 text-center">
        ...
        <p className="mt-1 text-sm text-slate-500">
          {isSignin ? 'Sign in to your account to continue' : 'Start reconciling in minutes'}
        </p>
      </div>
