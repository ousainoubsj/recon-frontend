...
import { Check, ChevronDown, ChevronLeft, ChevronRight, Download, FileText, MoreVertical } from 'lucide-react'
...
const pageItems: (number | '...')[] = [1, 2, 3, '...', 4]
  ...
  return (
    <div className="rounded-2xl border border-[#232D47] bg-[#0B122B]/70 p-5">
      ...
      <div className="mt-1 flex flex-wrap items-center justify-between gap-3 border-t border-[#232D47] pt-3">
        <p className="text-sm text-slate-400">Showing 1 to {rows.length} of 23 exports</p>
