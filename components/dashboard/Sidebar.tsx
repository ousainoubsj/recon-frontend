...
export default function Sidebar() {
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-[#232D47] bg-[#050F20] px-5 py-8 lg:flex">
      ...
      <Link
        href="#"
        className="mt-4 flex items-center justify-center gap-2 rounded-md bg-linear-to-r from-emerald-400 via-sky-500 to-indigo-500 py-2.5 text-sm font-semibold text-white shadow-md shadow-indigo-500/20 transition-all duration-300 hover:opacity-80 active:scale-95"
      >
