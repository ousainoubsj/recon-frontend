...
import { AreaChartSkeleton, BarChartSkeleton, DonutChartSkeleton } from '@/components/ui/chart-skeletons'
...
export default function ChartsOverview() {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
      ...
      <div className="flex flex-col rounded-2xl border border-[#232D47] bg-[#0D152A]/50 p-3">
        <CardHeader title="Breakdown by Category" control="All Time" />
        <div className="flex flex-1 items-center gap-4">
